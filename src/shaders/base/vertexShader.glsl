...
//void main()
//{
//    mat3 glNormalMatrix = transpose(inverse(mat3(worldToCamera * modelToWorld)));
...
//
//    vec3 halfway_vector = normalize(V+vec3(10.f,10.f,10.f).xyz);
...
//        pf = pow(nDotH, 4*0.1);
//    }
//    ambient += vec4(0.4f, 0.2f, 0.4f, 1.0f );
...
//        pf = pow(nDotH, 0.4);
//
//    ambient += vec4(0.5f, 0.2f, 0.2f, 1.0f );
//    diffuse += vec4(0.0f, 0.1f, 0.1f, 1.0f ) * nDotLi;
